...
<body id="page-top" class="index">
    ...
    <section id="team" class="bg-light-gray">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-1 col-lg-3 col-lg-offset-2">
                ...
                <div class="col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-2 col-lg-3 col-lg-offset-2">
                    <div class="team-member">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-lg-4 col-lg-offset-4 text-center">
                    <h2 class="section-heading" id="textocontactanos">Contactanos</h2>
                    <h3 class="section-subheading text-muted">En que te podemos ayudar.</h3>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Tu nombre *" id="name" required data-validation-required-message="Por favor escribi tu nombre.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="Tu mail *" id="email" required data-validation-required-message="Por favor escribi tu mail.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="tel" class="form-control" placeholder="Tu telefono *" id="phone" required data-validation-required-message=" Por favor escribi tu telefono.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="Tu mensaje *" id="message" required data-validation-required-message="Por favor escribi tu mensaje."></textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
